...
* The original package name 'com.task.Order Processing System' is invalid and this project uses 'com.task.Order.Processing.System' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/3.2.12/reference/messaging/kafka.html)
